    ...
    return (
        <Navbar expand="lg" className="nav-container">
            <Container fluid>
                ...
                >
                    ...
                    { !user.UID ? 
                        ...
                        :
                        <Button variant="outline-success" onClick={onButtonLogout}>Logout</Button>
                    }
                </Navbar.Collapse>
            </Container>
            <Modal show={modal} onHide={() => setModal(false)}>
                ...
                <Modal.Footer>
                    <Button variant="secondary" onClick={() => setModal(false)}>Tidak</Button>
                    <Button variant="primary" onClick={onButtonUserConfirm}>Iya</Button>
                </Modal.Footer>
            </Modal>
        </Navbar>
    )
